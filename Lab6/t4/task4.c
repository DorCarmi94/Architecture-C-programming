...
int main(int argc, char **argv) {
    ...
    {  
        ...
        else if(strcmp(lineFromTheUser,"procs\n")==0)
        {
            ...
            {
                if(strcmp(nextCommand->arguments[1],"~")==0)
                {
...
void execute(process** process_list,cmdLine *pCmdLine, int debugMode)
{
    ...
    {
        piping(debugMode,pCmdLine->arguments,pCmdLine->next->arguments);
    }
...
/*void piping(int dMode, char * const argumentsFrom[], char * const argumentsTo[])*/
void piping(int dMode, char * const argumentsFrom[], char * const argumentsTo[])
{
    ...
    if (child1 == 0) {    /* Child reads from pipe */
        ...
        int i=execvp(argumentsFrom[0],argumentsFrom);
        if(dMode)
        {
            fprintf(stderr, "(child1>exiting....\n");
        }
        ...
        child2=fork();
                    ...
                    if (child2 == 0) {    /* Child2 reads from pipe */
                        ...
                        int i_2=execvp(argumentsTo[0],argumentsTo);
